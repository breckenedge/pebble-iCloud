...
```
┌─────────────────┐           ┌──────────────────┐           ┌──────────────┐
│  Pebble Watch   │  ◄───────►│  Python Backend  │  ◄───────►│    iCloud    │
│  (PebbleJS App) │  HTTP/JSON│  (Flask + Auth)  │  pyicloud │  Reminders   │
└─────────────────┘           └──────────────────┘           └──────────────┘
                                       │
                                       ▼
                              ┌─────────────────┐
...
2. **Authentication** (`backend/auth_service.py`)
...
4. **Pebble App** - Pebble watch app not yet implemented (backend only)

## Future Enhancements

- [ ] Pebble watch app implementation
